...
<head>
    <title>West Marches Campaign</title>
    <style>
        body {
...
<body>
    <div style="background-color: #fff">
		...
		<div class="column" style="float: left; width: 33.33%;">
			<span style="text-decoration: underline;"><strong>Important Links</strong></span>
			<br />
			<a href="http://arsludi.lamemage.com/index.php/78/grand-experiments-west-marches/" target="_blank" rel="noopener">West Marches Explaination</a>
			<br />
			<a href="https://awwapp.com/b/urltxfbeli8tx/#" target="_blank" rel="noopener">West Marches Map</a>
			<br />
			<a href="https://homebrewery.naturalcrit.com/share/r1Wnz4l5cl" target="_blank" rel="noopener">Wilderness Survivor Guide Supplement</a>
			<br />
			<a href="https://top.gg/bot/279722369260453888" target="_blank" rel="noopener">Discord Dice Parser bot info</a>
		</div>
		<div class="break" style="clear:left;"><br /><br /></div>
		<div class="column" style="float: left; width: 33.33%;">
			<span style="text-decoration: underline;"><strong>Regions</strong></span><br /> Bitterlands (Unexplored)<br /> Blossoming Wastes (Unexplored)<br /> Dread Isles (Unexplored)<br /> Gloomwood (Unexplored)<br /> Goldenvale Plains (Unexplored)<br /> Hookslough Delta (Unexplored)<br /> Thrym (Unexplored)<br /> Titan's Shelf (Unexplored)
		</div>
		<div class="column" style="float: left; width: 33.33%;">
